package dmsDws.settings.websiteSettings.localization;
 ...
 */
public class LocalizationSettings extends Page {
    ...
    @FindBy(how = How.ID, using = "localization_currency_symbol_view")
    private WebElement currencySymbol;

    @FindBy(how = How.ID, using = "localization_currency_position_view")
    private WebElement currencyPosition;

    public LocalizationSettings(ConfigurationManager manager, WebDriver driver) {
    ...
    public String getCurrencyPosition(){return currencyPosition.getText();}
