 ...
 */
public class FormDws extends Page {
    ...
    public FormDws(ConfigurationManager manager, WebDriver driver) {
   ...
   /*methods for getting border color of input elements*/
    ...
    public void fillPhoneNum1() {
        phoneNumInput.clear();
        phoneNumInput.sendKeys(PropertyLoader.loadProperty(PropertySource.ENVIRONMENT,"phoneL1"));
    }
    ...
    public void fillEmail2() {
        emailInput.clear();
        emailInput.sendKeys(PropertyLoader.loadProperty(PropertySource.ENVIRONMENT, "Email1"));
    }
