 ...
 */
public class AdvSearchHorizWidgetSettingsDisplayedManager extends AdvSearchHorizTestBaseHome {

    private static final Logger LOG = LogFactory.getLogger(AdvSearchHorizWidgetSettingsDisplayedManager.class);
    ...
    public void adminPartDoesnotExist(){
