 ...
 */
public class AdvSearchHorizPriceSlideOnCustom extends AdvSearchHorizTestBaseCustom {


    private static final Logger LOG = LogFactory.getLogger(AdvSearchHorizPriceSlideOnCustom.class);
    ...
    public void yearSingleValueAppears() {
        driver.get(PropertyLoader.loadProperty("dws.url") + PropertyLoader.loadProperty("custom.url"));
        waitForJSandJQueryToLoad();
