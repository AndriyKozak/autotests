 ...
 */
public class AdvSearchHorizStyleSelectOnCustom extends AdvSearchHorizTestBaseCustom {

    private static final Logger LOG = LogFactory.getLogger(AdvSearchHorizStyleSelectOnCustom.class);
